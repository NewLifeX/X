...
namespace XCode.Common
{
    ...
    class PropertyInfoEx
    {
        ...
        #region 构造
        private static Dictionary<PropertyInfo, PropertyInfoEx> cache = new Dictionary<PropertyInfo, PropertyInfoEx>();
        /// <summary>
        /// 创建
        /// </summary>
        /// <param name="property"></param>
        /// <returns></returns>
        public static PropertyInfoEx Create(PropertyInfo property)
        {
            ...
            lock (cache)
            {
                ...
                PropertyInfoEx entity = new PropertyInfoEx();
        ...
        /// <returns></returns>
        public static PropertyInfoEx Create(Type type, String name)
        {
