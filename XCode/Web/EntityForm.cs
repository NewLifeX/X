...
namespace XCode.Web
{
    ...
    public class EntityForm
    {
        ...
        public virtual String ItemPrefix { get { return _ItemPrefix; } set { _ItemPrefix = value; Accessor = null; } }
        #endregion
        ...
        public EntityForm(Control container, Type type)
        {
            ...
            {
                if (context.Handler is Control) container = context.Handler as Control;
            }
        ...
        public event EventHandler<ExceptionEventArgs> OnGetEntity;

        /// <summary>把实体数据设置到表单后触发</summary>
        public event EventHandler<ExceptionEventArgs> OnSetForm;

        /// <summary>从表单上读取实体数据后触发</summary>
        public event EventHandler<ExceptionEventArgs> OnGetForm;

        /// <summary>验证时触发</summary>
        public event EventHandler<ExceptionEventArgs> OnValid;

        /// <summary>保存前触发，位于事务保护内</summary>
        public event EventHandler<ExceptionEventArgs> OnSaving;

        /// <summary>保存成功后触发，位于事务保护外</summary>
        public event EventHandler<ExceptionEventArgs> OnSaveSuccess;

        /// <summary>保存失败后触发，位于事务保护外</summary>
        public event EventHandler<ExceptionEventArgs> OnSaveFailure;
        #endregion
        ...
        public virtual IEntity Entity
        {
            get
            {
                if (_Entity == null && !_isGettingEntity)
                {
                    ...
                    if (OnGetEntity != null) OnGetEntity(this, new ExceptionEventArgs());
        ...
        public virtual void SetForm()
        {
            ...
            if (OnSetForm != null) OnSetForm(this, new ExceptionEventArgs());
        }
        ...
        public virtual void GetForm()
        {
            ...
            if (OnGetForm != null) OnGetForm(this, new ExceptionEventArgs());
        }
        ...
        public virtual Boolean ValidForm()
        {
            ...
            if (OnValid != null)
            {
                var e = new ExceptionEventArgs() { Cancel = false };
                OnValid(this, e);
...
", true);
        ...
        protected virtual void SaveFormFailure(Exception ex)
        {
            ...
            {
                var e = new ExceptionEventArgs() { Cancel = false, Exception = ex };
            ...
            {
                var control = FindControl(ItemPrefix + ae.ParamName);
