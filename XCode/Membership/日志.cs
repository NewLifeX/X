...
namespace XCode.Membership
{
    ...
    public partial class Log<TEntity> : ILog
    {
        ...
        [BindColumn(2, "Category", "类别", null, "nvarchar(50)", 0, 0)]
        ...
        [Description("操作")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(3, "Action", "操作", null, "nvarchar(50)", 0, 0)]
        ...
        [BindColumn(4, "LinkID", "链接", null, "int", 10, 0)]
        ...
        [Description("用户名")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(5, "UserName", "用户名", null, "nvarchar(50)", 0, 0)]
        ...
        [Description("用户编号")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(6, "CreateUserID", "用户编号", null, "int", 10, 0)]
        ...
        [Description("IP地址")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(7, "CreateIP", "IP地址", null, "nvarchar(50)", 0, 0)]
        ...
        [BindColumn(8, "CreateTime", "时间", null, "datetime", 3, 0)]
        ...
        [BindColumn(9, "Remark", "详细信息", null, "nvarchar(500)", 0, 0)]
