...
namespace XCode.Membership
{
    ...
    public partial class Menu<TEntity> : IMenu
    {
        ...
        [BindColumn(3, "DisplayName", "显示名", null, "nvarchar(50)", 0, 0)]
        ...
        [BindColumn(4, "ParentID", "父编号", null, "int", 10, 0)]
        ...
        [BindColumn(5, "Url", "链接", null, "nvarchar(200)", 0, 0)]
        ...
        [Description("排序")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(6, "Sort", "排序", null, "int", 10, 0)]
        ...
        [BindColumn(7, "Visible", "是否可见", null, "bit", 0, 0)]
        ...
        [DataObjectField(false, false, true, 1)]
        [BindColumn(8, "Necessary", "必要的菜单。必须至少有角色拥有这些权限，如果没有则自动授权给系统角色", null, "bit", 0, 0)]
        ...
        [DataObjectField(false, false, true, 200)]
        [BindColumn(9, "Permission", "权限子项。逗号分隔，每个权限子项名值竖线分隔", null, "nvarchar(200)", 0, 0)]
        ...
        [Description("备注")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(10, "Remark", "备注", null, "nvarchar(200)", 0, 0)]
