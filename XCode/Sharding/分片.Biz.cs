/*
 * XCoder v6.9.6391.39652
 * 作者：nnhy/X3
 * 时间：2017-07-17 01:21:36
...
namespace XCode.Sharding
{
    ...
    public class Shard : Shard<Shard> { }
    
    /// <summary>分片</summary>
    public partial class Shard<TEntity> : Entity<TEntity> where TEntity : Shard<TEntity>, new()
    {
        #region 对象操作
            ﻿
        static Shard()
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<TEntity> FindAllByEntityType(String entitytype)
        {
            if (Meta.Count >= 1000)
