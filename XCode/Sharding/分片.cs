...
namespace XCode.Sharding
{
    ...
    public partial class Shard<TEntity> : IShard
    {
        ...
        [BindColumn(3, "EntityType", "实体类", null, "nvarchar(50)", 0, 0)]
        ...
        [Description("连接名")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(4, "ConnName", "连接名", null, "nvarchar(50)", 0, 0)]
        ...
        [Description("表名")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(5, "TableName", "表名", null, "nvarchar(50)", 0, 0)]
        ...
        [BindColumn(6, "CreateUserID", "创建者", null, "int", 10, 0)]
        ...
        [Description("创建地址")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(7, "CreateIP", "创建地址", null, "nvarchar(50)", 0, 0)]
        ...
        [BindColumn(8, "CreateTime", "创建时间", null, "datetime", 3, 0)]
        ...
        [Description("更新者")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(9, "UpdateUserID", "更新者", null, "int", 10, 0)]
        ...
        [Description("更新地址")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(10, "UpdateIP", "更新地址", null, "nvarchar(50)", 0, 0)]
        ...
        [Description("更新时间")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(11, "UpdateTime", "更新时间", null, "datetime", 3, 0)]
        ...
        [BindColumn(12, "Remark", "备注", null, "nvarchar(500)", 0, 0)]
