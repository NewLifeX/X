...
namespace XCode.Sharding
{
    ...
    public partial class Shard<TEntity> : IShard
    {
        ...
        [BindColumn(3, "EntityType", "实体类", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("连接名")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(4, "ConnName", "连接名", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("表名")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(5, "TableName", "表名", null, "nvarchar(50)", 0, 0, true)]
