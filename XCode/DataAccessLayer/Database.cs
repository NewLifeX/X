    ...
    internal abstract class Database : IDatabase, IDisposable
    {
        ...
        public virtual DataSet Query(String sql)
        {
            ...
            try
            {
                ...
                {
                    //if (Debug) da.MissingSchemaAction = MissingSchemaAction.AddWithKey;
        ...
        /// <returns></returns>
        protected Boolean TryGetDataRowValue<T>(DataRow dr, String name, out T value)
        {
            value = default(T);
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        protected T GetDataRowValue<T>(DataRow dr, String name)
        {
            T value = default(T);
