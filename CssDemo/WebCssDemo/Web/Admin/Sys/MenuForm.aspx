<%@ Page Title="菜单管理" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MenuForm.aspx.cs" Inherits="MenuForm"%>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="C">
    ...
    <tr>
                ...
                <td><asp:TextBox ID="frmUrl" runat="server" Width="300px"></asp:TextBox></td>
            </tr>
    <tr>
    ...
    <tr>
                ...
                <td><asp:TextBox ID="frmPermission" runat="server" Width="150px"></asp:TextBox></td>
            </tr>
    <tr>
                <td align="right">是否显示：</td>
                <td><asp:CheckBox ID="frmIsShow" runat="server" Text="是否显示" /></td>
            </tr>
        </table>
    </div>
    </div>
