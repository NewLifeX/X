...
#>
        ...
        [BindColumn(<#=Field.ID#>, "<#=Field.ColumnName#>", "<#=des#>", <#=Field.Default==null?"null":"\""+Field.Default.Replace("\\", "\\\\")+"\""#>, "<#=Field.RawType#>", <#=Field.Precision#>, <#=Field.Scale#><#if(Field.Master){#>, Master=<#=Field.Master.ToString().ToLower()#><#}#>)]
