...
namespace NewLife.Net.Modbus
{
    ...
    public class SerialTransport : ITransport, IDisposable
    {
        ...
        void ITransport.Write(byte[] buffer, int offset, int count)
        {
            throw new NotImplementedException();
        }

        int ITransport.Read(byte[] buffer, int offset, int count)
        {
            throw new NotImplementedException();
        }

        void ITransport.Listen()
        {
            throw new NotImplementedException();
        }

        event TransportEventHandler ITransport.Received
        {
        ...
        public int Receive(byte[] buf_receive)
        {
            throw new NotImplementedException();
        }
