...
namespace NewLife.YWS.Entities
{
    ...
    public partial class Machine : IMachine
    {
        ...
        public virtual Int32 FeedliquorID
        {
            get { return _FeedliquorID; }
            set { if (OnPropertyChanging(__.FeedliquorID, value)) { _FeedliquorID = value; OnPropertyChanged(__.FeedliquorID); } }
        }
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case __.FeedliquorID : return _FeedliquorID;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.FeedliquorID : _FeedliquorID = Convert.ToInt32(value); break;
        ...
        public class _
        {
            ...
            ///<summary>液料规格ID</summary>
            public static readonly Field FeedliquorID = FindByName(__.FeedliquorID);
        ...
        /// <summary>取得机器零件规格字段名称的快捷方式</summary>
        class __
        {
            ///<summary>编号</summary>
            ...
            ///<summary>液料规格ID</summary>
            public const String FeedliquorID = "FeedliquorID";
