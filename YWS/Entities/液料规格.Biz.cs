...
namespace NewLife.YWS.Entities
{
    ...
    public partial class Feedliquor : YWSEntityBase<Feedliquor>
    {
        #region 扩展属性﻿

        [NonSerialized]
		private Customer _Customer;
		/// <summary>该液料规格所对应的客户</summary>
		[XmlIgnore]
		...
		/// <summary>该液料规格所拥有的机器零件规格集合</summary>
		[XmlIgnore]
		public EntityList<Machine> Machines
		{
			get
			{
                ...
                {
					_Machines = Machine.FindAllByFeedliquorID(ID);
        ...
        #region 扩展查询﻿
        /// <summary>
        /// 根据主键查询一个液料规格实体对象用于表单编辑
        /// </summary>
        /// <param name="id">编号</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Feedliquor FindByKeyForEdit(Int32 id)
        {
            Feedliquor entity = Find(new String[] { _.ID }, new Object[] { id });
            if (entity == null)
            {
                entity = new Feedliquor();
            }
            return entity;
        }
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Feedliquor FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Feedliquor> FindAllByCustomerID(Int32 customerid)
        {
            if (Meta.Count >= 1000)
        ...
        public static EntityList<Feedliquor> Search(String name, String cementGroup, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        {
        ...
        /// <param name="maximumRows">最大返回行数</param>
        /// <returns>记录数</returns>
        public static Int32 SearchCount(String name, String cementGroup, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        {
        ...
        private static String SearchWhere(String name, String cementGroup)
        {
            ...
            if (!String.IsNullOrEmpty(name)) sb.AppendFormat(" And {0} like '%{1}%'", _.CementGroup, cementGroup.Replace("'", "''"));
