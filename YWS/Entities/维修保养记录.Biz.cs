...
namespace NewLife.YWS.Entities
{
    ...
    public partial class Maintenance : YWSEntityBase<Maintenance>
    {
        ...
        public static Maintenance FindByKeyForEdit(Int32 id)
        {
            Maintenance entity = Find(new String[] { _.ID }, new Object[] { id });
            if (entity == null)
            {
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Maintenance FindByCustomerIDAndMachineID(Int32 customerid, Int32 machineid)
        {
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Maintenance> FindAllByCustomerID(Int32 customerid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Maintenance> FindAllByMachineID(Int32 machineid)
        {
            if (Meta.Count >= 1000)
                return FindAll(new String[] { _.MachineID }, new Object[] { machineid });
            else // 实体缓存
                return Meta.Cache.Entities.FindAll(_.MachineID, machineid);
        }
        #endregion
