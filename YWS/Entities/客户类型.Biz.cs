...
namespace NewLife.YWS.Entities
{
    ...
    public partial class CustomerType : EntityTree<CustomerType>
    {
        #region 扩展属性﻿
        //[NonSerialized]
        //private EntityList<Customer> _Customers;
        ///// <summary>该客户类型所拥有的客户集合</summary>
        //[XmlIgnore]
        //public EntityList<Customer> Customers
        //{
        //    get
        //    {
        //        if (_Customers == null && ID > 0 && !Dirtys.ContainsKey("Customers"))
        //        {
        //            _Customers = Customer.FindAllByCustomerTypeID(ID);
        //            Dirtys["Customers"] = true;
        //        }
        //        return _Customers;
        //    }
        ...
        #region 扩展查询﻿
        /// <summary>
        /// 根据主键查询一个客户类型实体对象用于表单编辑
        /// </summary>
        /// <param name="id">编号</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static CustomerType FindByKeyForEdit(Int32 id)
        {
            CustomerType entity = Find(new String[] { _.ID }, new Object[] { id });
            if (entity == null)
            {
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static CustomerType FindByNameAndParentID(String name, Int32 parentid)
        {
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<CustomerType> FindAllByName(String name)
        {
            if (Meta.Count >= 1000)
                return FindAll(new String[] { _.Name }, new Object[] { name });
            else // 实体缓存
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<CustomerType> FindAllByParentID(Int32 parentid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static CustomerType FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
        ...
        //{
        //    if (Customers != null) Customers.Delete();
        ...
        //public static EntityList<CustomerType> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
