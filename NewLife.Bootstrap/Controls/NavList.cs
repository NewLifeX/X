...
{
    [ToolboxData("<{0}:NavList runat=server></{0}:NavList>")]
    [ToolboxBitmap(typeof(System.Web.UI.WebControls.BulletedList))]
    [ParseChildren(true, "Items")]
    [PersistChildren(false)]
    public class NavList : WebControl, INamingContainer
    {
        ...
        private NavListCollection _items;
        ...
        public NavListCollection Items
        {
            get { return _items; }
        }
        ...
        {
            if (obj is NavListItem)
            {
                Items.Add((NavListItem)obj);
                return;
            }
        }
