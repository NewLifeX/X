...
namespace NewLife.CommonEntity
{
    ...
    public class AreaCode : AreaCode<AreaCode> { }
    
    /// <summary>地区编码</summary>
    public partial class AreaCode<TEntity> : Entity<TEntity> where TEntity : AreaCode<TEntity>, new()
    {
        #region 扩展属性﻿
        #endregion
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}地区编码数据……", typeof(TEntity).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}地区编码数据！", typeof(TEntity).Name);
        //}
        #endregion
