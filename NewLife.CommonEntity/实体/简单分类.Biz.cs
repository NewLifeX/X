...
namespace NewLife.CommonEntity
{
    ...
    public partial class SimpleTree<TEntity> : EntityTree<TEntity> where TEntity : SimpleTree<TEntity>, new()
    {
        ...
        #region 扩展查询﻿
        /// <summary>根据主键查询一个简单分类实体对象用于表单编辑</summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>根据名称索引查找</summary>
        /// <param name="name">名称索引</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        ...
        //public static EntityList<SimpleTree> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
