...
namespace NewLife.CommonEntity
{
    ...
    public partial class Area<TEntity> : IArea
    {
        ...
        [Description("旧版本代码")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(3, "OldCode", "旧版本代码", "", "int", 10, 0, false)]
        public Int32 OldCode
        {
            get { return _OldCode; }
        ...
        [BindColumn(4, "Name", "名称", "", "nvarchar(50)", 0, 0, true)]
        public String Name
        {
            get { return _Name; }
        ...
        [BindColumn(5, "ParentCode", "父地区代码", "0", "int", 10, 0, false)]
        ...
        [BindColumn(6, "Description", "描述", "", "ntext", 0, 0, true)]
