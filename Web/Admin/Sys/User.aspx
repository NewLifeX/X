<%@ Page Title="用户管理" Language="C#" MasterPageFile="~/Admin/ManagerPage.master" AutoEventWireup="true" CodeFile="User.aspx.cs" Inherits="Common_User" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="C">
    <div class="toolbar">
        <XCL:LinkBox ID="lbAdd" runat="server" BoxHeight="211px" BoxWidth="440px" Url="UserForm.aspx"
            IconLeft="~/Admin/images/icons/new.gif" EnableViewState="false"><b>添加用户</b></XCL:LinkBox>
    ...
    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="ods" AllowPaging="True" AllowSorting="True" CssClass="m_table" PageSize="20" CellPadding="0" GridLines="None" EnableModelValidation="True">
        <Columns>
            ...
            <asp:TemplateField HeaderText="是否管理员" SortExpression="IsAdmin">
                <ItemTemplate>
                    <asp:Label ID="IsAdmin1" runat="server" Text="√" Visible='<%# Eval("IsAdmin") %>' Font-Bold="True" Font-Size="14pt" ForeColor="Green"></asp:Label>
                    <asp:Label ID="IsAdmin2" runat="server" Text="×" Visible='<%# !(Boolean)Eval("IsAdmin") %>' Font-Bold="True" Font-Size="16pt" ForeColor="Red"></asp:Label>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="是否启用" SortExpression="IsEnable">
                <ItemTemplate>
                    <asp:Label ID="IsEnable1" runat="server" Text="√" Visible='<%# Eval("IsEnable") %>' Font-Bold="True" Font-Size="14pt" ForeColor="Green"></asp:Label>
                    <asp:Label ID="IsEnable2" runat="server" Text="×" Visible='<%# !(Boolean)Eval("IsEnable") %>' Font-Bold="True" Font-Size="16pt" ForeColor="Red"></asp:Label>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
            <XCL:LinkBoxField HeaderText="编辑" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="UserForm.aspx?ID={0}" Height="211px" Text="编辑" Width="440px" Title="编辑用户">
