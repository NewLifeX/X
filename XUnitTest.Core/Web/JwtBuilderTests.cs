...
-----END PUBLIC KEY-----";
    ...
    public void Decode()
    {
        var str = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJTdG9uZSIsImV4cCI6MTcyMTc1MDM2NiwiaWF0IjoxNzIxNzQzMTY2fQ.cLJyNGqwEPPFBEHfIDbhj8Q9trLTYfzVzFrb7KxGC_Q";
        var jwt = new JwtBuilder();
        var rs = jwt.TryDecode(str, out var msg);
