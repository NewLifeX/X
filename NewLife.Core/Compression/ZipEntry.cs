namespace NewLife.Compression
{
    public class ZipEntry
    {
        ...
        //        ///   the Last Modified time of the file in the file  If an entry is
        //        ///   added from a stream, the library uses <c>DateTime.Now</c> for this
        ...
        //        ///   cref="DateTime"/> values with a <see cref="DateTimeKind" />
        ...
        //        ///   the full precision of the <c>DateTime</c> datatype is not stored
        ...
        //        ///
        //        /// <para>
        //        ///   The <see cref="IO.FileAttributes">attributes</see> in NTFS include
        ...
        //        ///   adding an entry from the file  When adding an entry from a stream
        ...
        //        {
        //            // workitem 7071
        //            get { return (IO.FileAttributes)_ExternalFileAttrs; }
        //            set
        //            {
        ...
        //        ///   cref="ZipFile.AddEntry(string, IO.Stream)"/>.  Normally the
        ...
        //        ///   cref="ZipFile.AddEntry(string, IO.Stream)"/> method.  At the time
        ...
        //        ///   cref="ProvisionalAlternateEncoding"/> to <c>Encoding.UTF8</c>.
        //        /// </para>
        //        ///
        //        /// <para>
        ...
        //        ///     operating  The pitfall here is that if you create a zip in
        ...
        //        ///   {
        //        ///      zip.AlternateEnoding = Encoding.GetEncoding("ibm861");
        ...
        //        ///   database stored in the operating   The operating system stores
