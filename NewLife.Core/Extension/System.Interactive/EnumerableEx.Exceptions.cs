...
namespace System.Linq
{
    public static partial class EnumerableEx
    {
        ...
        public static IEnumerable<TSource> Finally<TSource>(this IEnumerable<TSource> source, Func finallyAction)
        {
            if (source == null)
                throw new ArgumentNullException("source");
        ...
        private static IEnumerable<TSource> Finally_<TSource>(this IEnumerable<TSource> source, Func finallyAction)
        {
            try
            {
