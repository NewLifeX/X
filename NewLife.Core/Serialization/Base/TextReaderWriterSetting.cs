...
namespace NewLife.Serialization
{
    ...
    public class TextReaderWriterSetting : ReaderWriterSetting
    {
        ...
        public Boolean UseBase64 { get { return _UseBase64; } set { _UseBase64 = value; } }

        private Boolean _UseEnumName = true;
        /// <summary>是否使用名称表示枚举类型，默认使用名称</summary>
        public Boolean UseEnumName { get { return _UseEnumName; } set { _UseEnumName = value; } }

        private Boolean _WriteType = true;
        /// <summary>是否输出类型</summary>
        public Boolean WriteType { get { return _WriteType; } set { _WriteType = value; } }
        #endregion
