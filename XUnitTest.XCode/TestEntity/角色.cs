...
namespace XCode.Membership
{
    ...
    public partial class Role2 : IRole2
    {
        #region 属性
        private Int32 _ID;
        /// <summary>编号</summary>
        ...
        public Boolean IsSystem { get => _IsSystem; set { if (OnPropertyChanging(__.IsSystem, value)) { _IsSystem = value; OnPropertyChanged(__.IsSystem); } } }
    ...
    public partial interface IRole2
    {
        #region 属性
        /// <summary>编号</summary>
        Int32 ID { get; set; }
