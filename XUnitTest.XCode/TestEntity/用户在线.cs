...
namespace XCode.Membership
{
    ...
    [DataObject]
    [Description("用户在线")]
    [BindIndex("IX_UserOnline2_UserID", false, "UserID")]
    [BindIndex("IX_UserOnline2_SessionID", false, "SessionID")]
    [BindIndex("IX_UserOnline2_CreateTime", false, "CreateTime")]
    [BindTable("UserOnline2", Description = "用户在线", ConnName = "test", DbType = DatabaseType.None)]
    public partial class UserOnline2 : IUserOnline2
    {
        #region 属性
        private Int32 _ID;
        /// <summary>编号</summary>
    ...
    public partial interface IUserOnline2
    {
        #region 属性
        /// <summary>编号</summary>
        Int32 ID { get; set; }
