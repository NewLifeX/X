...
{
    /// <summary>角色</summary>
    public partial class Role2 : Entity<Role2>
    {
        #region 对象操作
        static Role2()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Role2[角色]数据……");

        //    var entity = new Role2();
        //    entity.ID = 0;
        //    entity.Name = "abc";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Role2[角色]数据！");
        //}
        ...
        public static Role2 FindByID(Int32 id)
        {
            if (id <= 0) return null;
