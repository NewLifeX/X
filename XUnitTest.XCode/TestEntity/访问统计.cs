...
namespace XCode.Membership
{
    ...
    [DataObject]
    [Description("访问统计")]
    [BindIndex("IU_VisitStat2_Page_Level_Time", true, "Page,Level,Time")]
    [BindIndex("IX_VisitStat2_Level_Time", false, "Level,Time")]
    [BindTable("VisitStat2", Description = "访问统计", ConnName = "test", DbType = DatabaseType.None)]
    public partial class VisitStat2 : IVisitStat2
    {
        #region 属性
        private Int32 _ID;
        /// <summary>编号</summary>
    ...
    public partial interface IVisitStat2
    {
        #region 属性
        /// <summary>编号</summary>
        Int32 ID { get; set; }
