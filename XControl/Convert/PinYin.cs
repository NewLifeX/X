...
namespace XControl
{
    ...
    "Zhuang","Zhui","Zhun","Zhuo","Zi","Zong","Zou","Zu","Zuan","Zui","Zun","Zuo"
        ...
        public static string ConvertFast(string words)
        {
            ...
            {
                char[] noWChar = words.ToCharArray();

                for (int j = 0; j < noWChar.Length; j++)
                {
                    pyString += ConvertFast(noWChar[j]);
                }
            }
            return pyString;
        }
        ...
        public static string Convert(char word)
        {
            ...
            if (CNRegex.IsMatch(word.ToString()))
            {

                array = System.Text.Encoding.Default.GetBytes(word.ToString());
                i1 = (short)(array[0]);
                i2 = (short)(array[1]);
